    ...
    return (
      <div className='top-[82%] px-14 sm:absolute text-white -ml-9 md:m-0 mt-2'>
        ...
        <div className='my-4 mt-2 md:mt-6'>
          <button className='hidden sm:inline-block px-2 md:px-14 md:py-4 ml-3 sm:ml-0 bg-white text-black font-bold rounded-md sm:rounded-lg hover:bg-opacity-80'>Play</button>
