    ...
    return (
        <div className="mt-4 ml-3 sm:ml-9">
            ...
            <div>
                ...
                {similarTVShows.length>6 && loadMoreSTV && <div className="md:hidden" onClick={()=>{handleLoadMoreBtnClick("STV",similarTVShows.length)}}><LoadMoreBtn/></div>}    
            </div>}
            ...
            <div className="mt-3 sm:mt-6">
                ...
                {tvShowRecommendations.length>6 && loadMoreRTV && <div className="md:hidden" onClick={()=>{handleLoadMoreBtnClick("RTV",tvShowRecommendations.length)}}><LoadMoreBtn/></div>}
            </div>}
        </div>
    );
};
